...
/*
Plugin Name: 	Starter Templates for Elementor, Beaver Builder, SiteOrigin and Gutenberg
...
define( 'gradient_starter_templates_VERSION', '1.0.1' );
define( 'gradient_starter_templates_PLUGIN_NAME', 'ceylon-demo-installer' );
