...
class gradient_starter_templates {
	...
	public function run() {
		...
		$this->plugin_name = 'ceylon-demo-installer';
		$this->plugin_full_name = esc_html__('Ceylon Demo Setup','ceylon-demo-installer');
	...
	public function gradient_starter_templates_missing_notice() {
		...
		echo '<div class="error notice is-dismissible"><p><strong>' . esc_html($this->plugin_full_name) . '</strong> &#8211; ' . sprintf( esc_html__( 'This plugin requires %s Theme to be activated to work.', 'ceylon-demo-installer' ), '<a href="'.esc_url( $search_url ).'">' . esc_html__('Gradient Themes','ceylon-demo-installer'). '</a>' ) . '</p></div>';
	}
