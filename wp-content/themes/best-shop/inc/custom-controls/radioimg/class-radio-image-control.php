    ...
    */
	class best_shop_Radio_Image_Control extends WP_Customize_Control {
		...
		public function enqueue() {            
            wp_enqueue_style( 'best-shop-radio-image', get_template_directory_uri() . '/inc/custom-controls/radioimg/radio-image.css', null );
            wp_enqueue_script( 'best-shop-radio-image', get_template_directory_uri() . '/inc/custom-controls/radioimg/radio-image.js', array( 'jquery' ), false, true ); //for radio-image                
        }
