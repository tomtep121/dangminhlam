...
function best_shop_customize_register_social_links( $wp_customize ) {
    ...
    $wp_customize->add_section(
        ...
        array(
            'panel'     => 'theme_options',
            'title'     => esc_html__( 'Header Top Settings', 'best-shop' ),
            'priority'  => 10,
        )
    );
    ...
    $wp_customize->add_setting( 
        'ed_social_links', 
        array(
            'default'           => best_shop_default_settings('ed_social_links'),
    ...
    $wp_customize->add_control(
		new best_shop_Toggle_Control( 
			...
			array(
				'section'     => 'header_top',
				'label'	      => esc_html__( 'Enable Social Links', 'best-shop' ),
                'description' => esc_html__( 'Enable to show social links at header.', 'best-shop' ),
			)
		)
	);
    ...
    $wp_customize->add_control( 'top_bar_right_content', array(
          ...
          'choices' => array(
              ...
              'social' => __( 'Social (edit social links above)' ,'best-shop'),
