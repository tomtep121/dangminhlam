...
function best_shop_customize_register_post_page_settings( $wp_customize ) {
    ...
    $wp_customize->add_setting(
        'post_page_note_text',
        array(
            'default'           => best_shop_default_settings('post_page_note_text'),
            'sanitize_callback' => 'wp_kses_post' 
        )
    );
    
    $wp_customize->add_control(
        new best_shop_Note_Control( 
            $wp_customize,
            'post_page_note_text',
            array(
                'section'	  => 'post_page_settings',
                'label'       => esc_html__( 'Single Post Settings', 'best-shop' ),
                'description' => '<hr/>',
            )
        )
    ); 
    ...
    $wp_customize->add_control(
        new best_shop_Toggle_Control( 
            ...
            array(
                ...
                'description' => esc_html__( 'Enable to hide author shown below post title.', 'best-shop' ),
            )
        )
    );
    ...
    $wp_customize->add_control(
        new best_shop_Toggle_Control( 
            ...
            array(
                ...
                'description' => esc_html__( 'Enable to hide posted date shown below post title.', 'best-shop' ),
            )
        )
    );
    ...
    $wp_customize->add_control(
        new best_shop_Toggle_Control( 
            ...
            array(
                ...
                'description' => esc_html__( 'Enable to hide comments number shown below post title.', 'best-shop' ),
            )
        )
    );
    ...
    $wp_customize->add_control(
        new best_shop_Toggle_Control( 
            ...
            array(
                ...
                'description' => esc_html__( 'Enable to hide post reading calculation.', 'best-shop' ),
            )
        )
    );
